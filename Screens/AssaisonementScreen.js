...
const AssaisonementScreen = ({ navigation }) => {
    ...
    const assaisonement = ingredients.filter(ingredient => ingredient.category === 'Assaisonement');
    ...
    return (
        <View style={{ flex: 1 }}>
            ...
            {isSearching ? (
                ...
                <View>
                    <Text style={styles.bigTitle}>Assaisonement</Text>
                    <FlatList
                        data={assaisonement}
...
export default AssaisonementScreen;
